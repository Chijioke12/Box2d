...
call emcmake cmake .. -DCMAKE_BUILD_TYPE=Release -DBOX2D_BUILD_WASM=OFF -DBOX2D_BUILD_UNIT_TESTS=OFF -DBOX2D_BUILD_TESTBED=OFF -DBOX2D_BUILD_DOCS=OFF -DCMAKE_CXX_FLAGS="-O3 -s WASM=0 -s LEGACY_VM_SUPPORT=1"
